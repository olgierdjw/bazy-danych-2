...
<br>
Komponent Angular'a pobiera dane kolekcji przez połączenie z backendem, a ten dopiero z MongoDb.
Dane do prezentacji przychowywane są w jedynym dokumencie kolekcji `main-database.statistics`.
<br>
![img_4.png](img_4.png)
<br>

### Modyfikacja statystyk
Podczas zakupu biletu lub jego zwrotu dane są aktualizawone z wykorzystaniem funkcji pomocniczych:
<br>
1. Wywoływana po zakupie biletu:
```python
...
```
2. Po anulowaniu zakupionego biletu
```python
...
Lista dostępnych pociągów:
<br>
![img_16.png](img_16.png)
<br>
Po wybraniu pociagu następuje wybór miejsca.
Maska zajętych miejsc w dokumencie konkretnego pociagu koloruje miejsca w zależności od ich dostępności.
Zaznaczenie miejsca czerwonego pokazuje szczególy rezerwacji.
W przypadku wolnego, dostępna jest opcja zakupienia biletu na wskazane miejsce.
Na jedno konto użytkownika można kupić wiele biletów. 
Bilety jednego użytkownika w jednym pociagu rozróżniane są przed przez dane z dodatkowego pola oznaczającego posiadacza biletu.
<br>
![img_7.png](img_7.png)
<br>
...
### Widok użytkownika
Pod formularzem dodania nowego konta, znajduje się lista wszyskich zarejestrowanych użytkowników.
<br>
![img_10.png](img_10.png)
<br>

Wybranie powiązanego z użytkownikiem przycisku doprowadza nas to strony użytkwonika.
Oprócz podsumowania, widoczna jest historia zakupów.
Bilety aktywne mają możliwość anulowania.
